<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Client.aspx.cs" Inherits="ProjetVeille.Client" %>
...
<body>
    ...
    <div class="popup_block" >
        ...
        <div class="onglets">
           <span class="onglet_1 onglet" id="onglet_ajout" onclick="javascript:change_onglet('ajout');">Ajouter un profil</span>
    ...
    <asp:Button ID="createBtn" runat="server" Text="Creer le profil" OnClick="createBtn_Click" />  
                <br />
                <br />
                <br />
            </div>
